...
// App.get to send the page to the home route
app.get("/", function(req, res){
  posts.forEach(function(post){
    console.log(post["title"]);
  });
  res.render("home", {post1: homeStartingContent, blogPosts: posts});
});
...
// App.get to send the page to the about route
app.get("/about", function(req, res){
  res.render("about", {aboutDetails: aboutContent});
});

// App.get to send the page to the contact route
app.get("/contact", function(req, res){
  res.render("contact", {contactDetails: contactContent});
});

// App.get to send the page to the compose route
app.get("/compose", function(req, res){
  res.render("compose", {});
});

// app.post to receive data from compose page
